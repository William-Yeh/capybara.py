...
_SESSION_METHODS = [
    ...
    "evaluate_script_async", "execute_script", "fieldset", "frame", "go_back", "go_forward",
    "has_current_path", "has_no_current_path", "open_new_window", "reset", "save_page",
...
class Session(SessionMatchersMixin, object):
    ...
    def evaluate_script_async(self, script, *args):
        """
        ...
        args = [arg.base if isinstance(arg, Base) else arg for arg in args]
        result = self.driver.evaluate_script_async(script, *args)
        return self._wrap_element_script_result(result)
